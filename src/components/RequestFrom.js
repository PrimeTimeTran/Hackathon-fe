...
const RequestForm = ({ open, setOpen }) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          Please help us understand your needs better through the below
          information. We will send help as soon as possible.
        </DialogContentText>
        <TextField
          autoFocus
          margin="dense"
        ...
        <div style={{ display: "flex", gap: "2rem" }}>
          ...
          <Dropdown>
            ...
            <Dropdown.Menu variant="dark">
              <Dropdown.Item name="Self" onClick={handleClick}>
                Self
              </Dropdown.Item>
              <Dropdown.Item name="Family" onClick={handleClick}>
                Family
              </Dropdown.Item>
              <Dropdown.Item name="Neighbor" onClick={handleClick}>
                Neighbor
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
